...
This is a homework for the Java Arrays

## IntelliJ IDEA project configuration
1. Clone this project to your local environment

    ```git clone https://github.com/kermek/java-basics-hw09.git```
...
9. Complete all TODO tasks in the ArrayUtil class.
10. Execute tests. 
11. Add 2 more tests for each method by adding the test data.

## ArrayUtil assignment

Implement method in the ArrayUtil class, which finds common elements of two String arrays.
Arguments: two String arrays.
